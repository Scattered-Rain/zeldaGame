...
public class StabSwordSkill extends Skill{
	
	/** Cool Down */
	private static final float COOL_DOWN = 0.3f;
	/** Player Freeze */
	private static final float PLAYER_FREEZE = 0.1f;
	
	
	/** Constructs new Flame Skill */
	public StabSwordSkill(MobEntity player) {
	...
	private static class FlameProjectile extends Projectile{
		...
		private static final SpriteEnum SPRITE = SpriteEnum.STAB_SWORD;
		private static final Damage.DamageType DAMAGE_TYPE = Damage.DamageType.EDGED;
		private static final int DAMAGE_VAL = 3;
		private static final float DESPAWN_TIME = 0.1f;
		private static final float SPEED = (Constants.TILE*0.3f)/DESPAWN_TIME;
		...
		public FlameProjectile(MapScene map, Point location, Direction dir, MobEntity user) {
			...
			super.setRenderLayer(EntityRenderLayer.SUB_MOB);
		}
	}
